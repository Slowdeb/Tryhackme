...
Another way to finish this room without escalating privileges to "root", is if out of the blue we would know the path of “root's” final flag and we could use “nano” to read its contents:
